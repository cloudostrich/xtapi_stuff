...
def main():
    ...
    tcm = osbrain.run_agent('Tcm', base=Bob)
    bob = osbrain.run_agent('Bob', base=Bob)
    sprd = osbrain.run_agent('Sprd', base=Bob)
    Connect()
    tcm.connect(NotifyTcm.addr, handler='custom_log')
    bob.connect(NotifyTF.addr, handler='custom_log')
    sprd.connect(NotifySprd.addr, handler='custom_log')
    ...
    tcm_mth = ('25Jan19', '22Feb19', '25Mar19', '22Apr19', '27May19', '24Jun19')
